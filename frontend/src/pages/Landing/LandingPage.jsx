...
const LandingPage = ({ mobile_mockup4, SERVICES_DATA, hoveredAvatar, handleMouseEnter, handleMouseLeave, Team_person_1, Team_person_2, Team_person_3, Team_person_4, Stats_image }) => {
  useEffect(() => {
    AOS.init();
  }, []);
  return (
